...
public class SearchPageCategoryVO implements Serializable {
    ...
    public SearchPageCategoryVO() {
    }

    public SearchPageCategoryVO(String firstLevelCategoryName, List<GoodsCategory> secondLevelCategoryList, String secondLevelCategoryName, List<GoodsCategory> thirdLevelCategoryList, String currentCategoryName) {
