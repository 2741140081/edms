...
public class NewBeeMallOrderListVO implements Serializable {
    ...
    public NewBeeMallOrderListVO() {
    }

    public NewBeeMallOrderListVO(Long orderId, String orderNo, Integer totalPrice, Byte payType, Byte orderStatus, String orderStatusString, String userAddress, Date createTime, List<NewBeeMallOrderItemVO> newBeeMallOrderItemVOS) {
